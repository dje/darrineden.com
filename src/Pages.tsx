...
export const Carbon = () => <h1>Carbon Page</h1>
export const Home = () => <div>
    ...
    <ul>
        ...
        <li><a href="https://storage.googleapis.com/darrineden/Darrin_Eden_Resume.docx">Resume
            (word)</a> <a
            href="https://storage.googleapis.com/darrineden/Darrin_Eden_Resume.pdf">(pdf)</a></li>
